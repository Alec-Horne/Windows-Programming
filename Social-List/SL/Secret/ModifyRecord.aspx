...
<body>
    ...
    <div style="height: 615px">
        ...
        <asp:Label ID="TitleLabel" runat="server" Font-Bold="True" Font-Names="Arial Rounded MT Bold" Font-Size="XX-Large" ForeColor="#6666FF" Text="Modify Existing Record"></asp:Label>
    
        <asp:Label ID="Label1" runat="server" style="z-index: 1; left: 16px; top: 90px; position: absolute; height: 24px" Text="Enter the name of the record you would like to modify below, then click the find record button."></asp:Label>
        <asp:Label ID="Label3" runat="server" style="z-index: 1; left: 14px; top: 112px; position: absolute" Text="Once the data is processed, change the fields that need modified and click the update button.  This"></asp:Label>
        <asp:Label ID="Label4" runat="server" style="z-index: 1; left: 15px; top: 134px; position: absolute" Text="will commit the changes to the database."></asp:Label>
        ...
        <asp:Button ID="Button2" runat="server" style="z-index: 1; left: 26px; top: 557px; position: absolute; width: 123px" Text="Update Record" OnClick="Button2_Click" />
...
<script language="C#" runat="server">
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
			try{
				...
				InfoLabel.Text = "Your requested record is below.";
			} catch (Exception) {
